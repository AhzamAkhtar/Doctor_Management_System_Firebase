    ...
    <>
      <div className="main_news_doctor" style={{marginLeft:"20px"}}>
        <h1 className="text-center" style={{ marginTop: "10px" }}>
         Doctors For Nutrition Counselling
        </h1>
              ...
              <div className="col-md-3 my-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">Nutrition Counselling</h6>
...
export default Nutritioncounselling;
